...
```yaml
name        : Srikala Karimisetty
location    : Nandyal, Andhra Pradesh, India
education   : B.Tech CSE — Santhiram Engineering College (2022–2026)
gpa         : 8.0 / 10
internship  : DevOps + AWS @ LogicLab Solutions, Hyderabad (6 months)
currently   : Learning Python for AI/ML | Building DevOps Projects
looking_for : Full-time DevOps / Cloud / SRE roles — 2026
linkedin    : linkedin.com/in/srikala-karimisetty
```
